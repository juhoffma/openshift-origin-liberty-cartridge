...
OPENSHIFT_LIBERTY_IP = sys.argv[1]
...
###############################################################################
# Configure Liberty to use a specific IP address
...
# Add new properties
attr = []
attr.append([['name','com.ibm.CORBA.LocalHost'],['required','true'],['value', OPENSHIFT_LIBERTY_IP]])
...
for endpoint in endpoints:
	AdminConfig.modify(endpoint, '[[host ' + OPENSHIFT_LIBERTY_IP + ']]')
